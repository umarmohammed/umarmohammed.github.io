...
The problem is, writing books sucks. A lot. *And it's all because of paper.* So I'm not doing that anymore.
...
Well, I was wrong. Granted, I didn't just update the code samples and call it a day, because I wanted the book to be the best it could possibly be, and improve on the original. But although I didn't keep track of hours, I'm fairly certain that the updated took every bit as much effort as the one that came before.
